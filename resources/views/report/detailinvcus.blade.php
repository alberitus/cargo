...
<div class="page-inner">
    <div class="page-header">
        <h3 class="fw-bold mb-3">Detail Invoice Customer</h3>
        <ul class="breadcrumbs mb-3">
            ...
            <li class="nav-item">
                <a href="#">Detail Invoice Customer</a>
            </li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Detail Invoice Customer</h4>
                </div>
                <div class="card-body">
                        ...
                        <table id="add-row" class="display table table-striped table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="10" class="text-center" style="width: 30%">Amount</th>
